/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example worker/env.d.ts` (hash: d4296eda3f379fae604c9eaef2efb0bb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_SITE_URL" | "GOOGLE_OIDC_REDIRECT_URI" | "TERMS_VERSION" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "OIDC_COOKIE_KEY" | "SESSION_PEPPER" | "PSEUDONYM_KEY" | "OPENROUTER_API_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET">> {}
}
