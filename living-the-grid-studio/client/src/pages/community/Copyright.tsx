...
export default function Copyright() {
  ...
  return (
    <LegalLayout title="Copyright and Takedowns" lastUpdated="July 13, 2026" intro="Tomodachi respects creators and responds to specific, good-faith reports about material shared through the community platform.">
      ...
      <p>Send complete notices to David Ortiz, the operator, at <code>legal@tomodachi.pw</code> or by mail to 122 W Taylor St, DeKalb, Illinois 60115, United States. General moderation concerns should use the in-product Report control instead.</p>
