...
export default function Security() {
  ...
  return (
    ...
    >
      ...
      <p>Studio AI is optional, requires a clear consent step, and applies only validated, reviewable project data after you approve the result. Moderation AI may classify, prioritize, summarize, or recommend a response, but it has no credentials or route that can publish, hide, suspend, resolve, or delete. An authorized human approves every enforcement action, and the action is recorded in the moderation audit trail.</p>
