...
export default function Privacy() {
  ...
  return (
    ...
    >
      <h2>1. Who we are</h2>
      <p>
        Tomodachi (&quot;we,&quot; &quot;us,&quot; &quot;our&quot;) operates the
        websites at <code>tomodachi.pw</code> and <code>tomodachi.brave</code>{" "}
        (collectively, the &quot;Site&quot;). You can reach us by email at{" "}
      ...
      <ul>
        <li>
          ...
          and returning password-breach results.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          Only the first five characters of your password hash are ever sent.
        </li>
      </ul>
      ...
      <p>
        ...
        respond within 30 days. You can also withdraw consent at any time by
        clearing the cookie consent banner choices in your browser&apos;s site
        data.
      </p>
      ...
      <h2>8. Contact</h2>
      <p>
        Operator: David Ortiz. Questions or requests may be sent to{" "}
        <a href="mailto:privacy@tomodachi.pw">privacy@tomodachi.pw</a> or by
        mail to 122 W Taylor St, DeKalb, Illinois, United States.
      </p>
    </LegalLayout>
  );
}
