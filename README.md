...
- **Studio** ([/studio](https://tomodachi.pw/studio)) — Import a face photo, character art, logo, meme, or JSON file; crop/frame it for Face Paint, a portrait, or an icon; reduce it to the Studio's 84-color working palette; preview before commit; touch up; optimize; and export manual Copy Guides. The palette is a Studio aid, not verified proprietary game data.
